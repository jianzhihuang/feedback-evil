...
```bash
# 版本查詢
uvx feedback-evil version       # 檢查版本

# 介面測試
uvx feedback-evil test --web    # 測試 Web UI (自動持續運行)
uvx feedback-evil test --desktop # 測試桌面應用程式 (v2.5.0 新功能)

# 調試模式
MCP_DEBUG=true uvx feedback-evil test

# 指定語言測試
MCP_LANGUAGE=en uvx feedback-evil test --web    # 強制使用英文介面
MCP_LANGUAGE=zh-TW uvx feedback-evil test --web  # 強制使用繁體中文
MCP_LANGUAGE=zh-CN uvx feedback-evil test --web  # 強制使用簡體中文
```
...
**Q: 中文字符亂碼**
A: 已在 v2.0.3 修復。更新到最新版本：`uvx feedback-evil`
